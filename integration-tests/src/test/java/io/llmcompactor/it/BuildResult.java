...
public class BuildResult {
  ...
  public BuildResult(
      String output, String summaryJson, int exitCode, Path buildDir, Path projectDir) {
    this.output = output;
  ...
  /**
   * Parses the summary JSON and returns the root JsonNode. Returns null if no summary was
   * generated.
   */
