...
class GradleOptionTests {
    ...
    class OutputPathTests {
        ...
        void testCustomOutputPath() throws Exception {
            ...
            assertThat(result.projectDir().resolve(customPath))
                .exists();
        }
    }
    ...
    class ParityTests {
        ...
        void testBothProduceJson() throws Exception {
            BuildResult mavenResult = MavenBuild.inProject("maven-test-project")
                .withGoal("verify")
                .withProperty("llmCompactor.outputAsJson", "true")
                .execute();

            BuildResult gradleResult = GradleBuild.inProject("gradle-test-project")
                .withTask("test")
                .withProperty("llmCompactor.outputAsJson", "true")
                .execute();
